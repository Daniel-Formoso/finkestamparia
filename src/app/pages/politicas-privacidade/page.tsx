...
import Header from "@/app/components/header-politicas-privacidade/page";
      ...
      <main className="mt-24 max-w-5xl mx-auto px-6 py-10 text-[#F0F0EC] rounded-xl shadow-lg">
        ...
        <section className="mb-8">
          ...
          <p className="text-base leading-relaxed">
            Coletamos apenas as informações que você nos fornece
            voluntariamente, como nome, e-mail, telefone ou mensagem, ao entrar
            em contato por formulário, WhatsApp, Instagram ou e-mail.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-base leading-relaxed">
            ...
            solicitações de orçamento ou contato. Não compartilhamos suas
            informações com terceiros para fins comerciais.
          </p>
        </section>
