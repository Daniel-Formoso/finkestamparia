...
const links = [
  ...
  { name: "Avaliações de Clientes", href: "#clientestrabalhos" },
    ...
    <div id="sobre" className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      >
        <div
          ...
          className="aspect-1097/845 w-274.25 bg-gradient-to-tr from-[#F2F2F2] via-[#FFFFFF] to-[#D9D9D9] opacity-30"
        />
      </div>
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.name} className="flex flex-col-reverse gap-1">
                ...
                <dd className="text-4xl font-semibold tracking-tight text-[#EFA531]">
                  {stat.value}
                </dd>
              </div>
            ))}
